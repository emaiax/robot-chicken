...
RSpec.describe RobotChicken::Parser do
  let(:parsed_card) do
    ...
    "Sorcery\n\n" \
    "<em>Target player reveals his or her hand. You choose a nonland card from " \
    "it with converted mana cost 3 or less. That player discards that card.</em>"
  end

  let(:parsed_rulings) do
    "<strong>Inquisition of Kozilek</strong> rulings:\n\n" \
    "<strong>2014-02-01:</strong> If you target yourself with this spell, you must " \
    "reveal your entire hand to the other players just as any other player would."
  end
